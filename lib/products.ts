...
export const products: Product[] = [
  ...
  {
    slug: "polyester-conveyor-belt",
    name: "Polyester Conveyor Belt",
    category: "conveyor-belts",
    eyebrow: "Multi-ply EP carcass",
    summary: "A multi-layer polyester-canvas conveyor belt with wear-resistant rubber covers for conveying small and medium blocks, powder and granular materials at common temperatures.",
    description: "A multi-ply polyester canvas core is bonded together and covered top and bottom with high-strength, wear-resistant, flexible rubber. It conveys small and medium blocks, powder, granular and other materials where no special corrosion resistance is required, offering good flexibility, good trough formation and cost-effective operation.",
    applicationIntro: "Polyester conveyor belts suit long-distance, high-capacity, high-speed material transport and are widely used in mining, quarries, chemical plants and the construction industry. Belt width, ply construction and cover grade are confirmed against the material, tonnage and operating conditions before quotation.",
    featureHeading: "Flexible, troughable and cost-effective multi-ply conveying.",
    features: [
    ...
    applications: [
      ...
      "Long-distance, high-capacity conveying lines",
      "High-speed material transport",
      "Powder, granular and small-block material handling",
    ],
    specifications: [
      { label: "Carcass", value: "Multi-ply polyester canvas core" },
      { label: "Covers", value: "High-strength, wear-resistant flexible rubber" },
      { label: "Reference standards", value: "GB/T7984-2001, DIN22102, BS490, AS1332, RMA, JISK6322, SABS1173" },
      { label: "Operating condition", value: "Common-temperature conveying of powder, granular and small-to-medium block materials" },
    ],
    precautions: [
      "Store rolls off the ground in a clean, dry, ventilated place away from direct sunlight",
      "Keep away from heat sources, ozone-generating devices and open flames",
    ...
    inquiryChecklist: [
      ...
      "Cover thickness or cover grade requirement",
      "Operating temperature and environment",
      "Belt speed and conveyor length",
      "Quantity required and destination",
    ],
    seo: {
      title: "Polyester Conveyor Belt (EP) for Mining, Quarry and General Industry",
      description: "Multi-ply polyester-canvas conveyor belt with wear-resistant rubber covers, referenced to GB/T7984, DIN22102, BS490 and AS1332, for powder, granular and small-block material transport.",
    },
  ...
  },
  {
    ...
    applications: [
      ...
      "Ore ports and terminals",
      "Metallurgical industry",
      "Power industry",
      "Chemical industry",
    ],
    specifications: [
      { label: "Tension element", value: "New-type steel cable, with transverse steel reinforcing layers on one or both sides" },
      { label: "Performance", value: "High tensile strength, low extensibility, small pulley diameter, uniform cable tension, good rubber-to-steel adhesion" },
      { label: "Cover types", value: "General, coal-mine fire-retardant, general-purpose fire-retardant, cold-resistant, wear-resistant, heat-resistant, acid-alkali resistant, oil resistant" },
      { label: "Standard specification", value: "Number of steel cords / cover rubber property and grades / steel-cord adhesion (see specification tables)" },
    ],
    patterns: [
      { name: "General type", description: "Standard cover for general-purpose conveying duties." },
      { name: "Fire-retardant type for coal mines", description: "Flame-retardant cover construction for coal-mine service." },
      { name: "General-purpose fire-retardant type", description: "Flame-retardant cover for general industrial use." },
      { name: "Cold resistant type", description: "Cover selected for low-temperature operating environments." },
      { name: "Wearable type", description: "Wear-resistant cover for abrasive material handling." },
      { name: "Heat resistant type", description: "Cover selected for high-temperature service." },
      { name: "Acid-alkali resistant type", description: "Cover resistant to acid and alkali exposure." },
      { name: "Oil resistant type", description: "Cover resistant to oil exposure." },
    ],
    precautions: [
      "Store rolls off the ground in a clean, dry, ventilated place away from direct sunlight",
      "Keep away from heat sources, ozone-generating devices and open flames",
    ...
    inquiryChecklist: [
      "Conveyed material and lump size",
      "Required belt width, length and strength grade",
      "Cover rubber property and grade (general / fire-retardant / cold-resistant / heat-resistant / oil-resistant, etc.)",
      "Number of steel cords and adhesion requirements",
      "Operating environment, temperature and flammability requirements",
      "Quantity required and destination",
    ],
    seo: {
      title: "Steel Cord Conveyor Belt for Heavy-Load, Long-Distance Conveying",
      description: "Steel-cable reinforced conveyor belt with high tensile strength and low elongation for coal, ore port, metallurgical, power and chemical industries, with general, fire-retardant, cold-resistant and heat-resistant cover types.",
    },
...
const zhProducts: Record<string, Omit<Product, "slug" | "category">> = {
  ...
  "polyester-conveyor-belt": {
    name: "聚酯芯输送带",
    eyebrow: "多层 EP 带芯",
    summary: "多层聚酯帆布带芯、覆盖耐磨橡胶的输送带，适用于常温下输送中小块状、粉状和颗粒状物料。",
    description: "多层聚酯帆布带芯经粘合后，上下覆盖高强度、耐磨、柔韧的橡胶层。适用于输送中小块状、粉状、颗粒状等无特殊腐蚀要求的物料，具有良好的柔韧性、成槽性与经济性。",
    applicationIntro: "聚酯芯输送带适用于长距离、大运量、高速输送工况，广泛用于矿山、采石场、化工厂和建筑行业。带宽、层数与覆盖胶等级需结合物料、运量和运行工况在报价前确认。",
    featureHeading: "柔韧、易成槽、经济可靠的多层输送带。",
    features: [
      "多层聚酯帆布带芯，强度高、尺寸稳定",
      "高强度、耐磨、柔韧的橡胶覆盖层",
      "柔韧性好、成槽性好，物料承载稳定",
      "适用于粉状、颗粒状及中小块状物料",
      "常温输送工况下经济性更优",
      "参照标准包括 GB/T7984、DIN22102、BS490、AS1332 等",
    ],
    applications: [
      "矿山与采石作业",
      "化工厂",
    ...
    specifications: [
      { label: "带芯", value: "多层聚酯帆布" },
      { label: "覆盖胶", value: "高强度、耐磨、柔韧橡胶" },
      { label: "参照标准", value: "GB/T7984-2001、DIN22102、BS490、AS1332、RMA、JISK6322、SABS1173" },
      { label: "运行条件", value: "常温下输送粉状、颗粒状及中小块状物料" },
    ],
    precautions: [
      "卷装应离地存放于清洁、干燥、通风处，避免阳光直射",
      "远离热源、臭氧发生装置和明火",
    ...
    seo: {
      title: "聚酯芯输送带（EP）— 矿山、采石与一般工业用",
      description: "多层聚酯帆布带芯输送带，覆盖耐磨橡胶，参照 GB/T7984、DIN22102、BS490、AS1332，适用于粉状、颗粒状及小块状物料输送。",
    },
    sourceUrl: "https://www.respowerbelt.com/h-col-122.html",
  },
  "steel-cord-conveyor-belt": {
    ...
    specifications: [
      { label: "张力元件", value: "新型钢丝绳，一侧或两侧铺设横向钢丝增强层" },
      { label: "性能", value: "高拉伸强度、低伸长率、较小滚筒直径、钢丝绳张力均匀、橡胶与钢丝绳粘合良好" },
      { label: "覆盖胶类型", value: "通用型、煤矿用阻燃型、通用阻燃型、耐寒型、耐磨型、耐热型、耐酸碱型、耐油型" },
      { label: "标准规格", value: "钢丝绳根数 / 覆盖胶特性与等级 / 钢丝绳粘合力（见规格表）" },
    ],
    patterns: [
