...
export default function ContactPage() {
  return (
    ...
    <section className="section shell contact-grid"><div><p className="eyebrow">Company</p><h2>Shandong Respower Industrial Co., Ltd.</h2><p>Linyi, Shandong Province, China</p><div className="contact-block"><span>Planned sales email</span><a href="mailto:sales@ovbel.com">sales@ovbel.com</a></div><div className="contact-block"><span>Website</span><a href="https://ovbel.com">ovbel.com</a></div><p className="muted">Telephone, WhatsApp and full address will be added after company confirmation.</p></div><div className="contact-panel"><h2>For a faster response</h2><ul className="check-list"><li>Product name, model or OEM number</li><li>Dimensions, material or drawing</li><li>Application and operating conditions</li><li>Required quantity and destination country</li></ul><Link className="button" href="/request-quote">Prepare an inquiry</Link></div></section></>
  );
}
